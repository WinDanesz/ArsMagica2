...
public class RenderRiftStorage extends Render<EntityRiftStorage> {
    ...
    private static final ResourceLocation TEXTURE_MAIN = new ResourceLocation("arsmagica2", "textures/entities/rift.png");
    private static final ResourceLocation TEXTURE_SECONDARY = new ResourceLocation("arsmagica2", "textures/entities/rift_2.png");
