...
public class GuiHudCustomization extends GuiScreen {
    ...
    public void initGui() {
        ...
        doShowBars = ArsMagica.config.showHudBars();
    ...
    private void setOptionsVisibility(boolean visible) {
        ...
        manaBarWidthMinus.visible = visible;
        manaBarWidthPlus.visible = visible;
        manaBarHeightMinus.visible = visible;
        manaBarHeightPlus.visible = visible;
        burnoutBarWidthMinus.visible = visible;
        burnoutBarWidthPlus.visible = visible;
        burnoutBarHeightMinus.visible = visible;
        burnoutBarHeightPlus.visible = visible;
    }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        // Draw bar size labels when options are visible
        if (showOptions) {
            int centerX = width / 2;
            int y = height - 220;
