...
public class GuiMagiciansWorkbench extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(ArsMagica.MODID, "textures/gui/magicians_workbench.png");
    ...
    protected void actionPerformed(GuiButton par1GuiButton) throws IOException {
        ...
        if (par1GuiButton == clearGridOne) {
            for (int i = 0; i < 9; ++i) {
                ...
                this.mc.playerController.windowClick(this.inventorySlots.windowId, slot.slotNumber, 0, ClickType.QUICK_MOVE, this.mc.player);
            }
