...
import am2.network.packets.PacketImbueArmor;
...
public class GuiArmorImbuer extends GuiContainer {
    ...
    private static final ResourceLocation foreground = new ResourceLocation(ArsMagica.MODID, "textures/gui/armor_upgrade_gui.png");
    ...
    protected void mouseClicked(int par1, int par2, int par3) throws IOException {
        if (hoveredID != null) {
            AMNetworkHandler.getNetwork().sendToServer(new PacketImbueArmor(tileEntity.getPos(), hoveredID));
