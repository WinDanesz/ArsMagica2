...
public class GuiSpellBook extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(ArsMagica.MODID, "textures/gui/spell_book_gui.png");
    ...
    public GuiSpellBook(InventoryPlayer inventoryplayer, ItemStack spellBookStack, InventorySpellBook inventoryspellbook, boolean fromBaubles) {
        super(new ContainerSpellBook(inventoryplayer, spellBookStack, inventoryspellbook, fromBaubles));
