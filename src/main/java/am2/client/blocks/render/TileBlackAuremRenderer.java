...
public class TileBlackAuremRenderer extends TileEntitySpecialRenderer<TileEntityBlackAurem> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation("arsmagica2:textures/blocks/custom/black_aurem.png");
    ...
    private void renderArsMagicaEffect(Tessellator tessellator, float offset, float scale) {
        ...
        GL11.glRotatef(ArsMagica.proxy.getLocalPlayer().ticksExisted, 0, 0, 1);
