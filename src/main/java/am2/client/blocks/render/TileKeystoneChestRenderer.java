...
public class TileKeystoneChestRenderer extends TileEntitySpecialRenderer<TileEntityKeystoneChest> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("arsmagica2", "textures/blocks/custom/keystone_chest.png");

    public TileKeystoneChestRenderer() {
        model = new ModelChest();
    }

    public void render(TileEntityKeystoneChest chest, double d, double d1, double d2, float var8, int destroyStage, float alpha) {
        int i = 2;
