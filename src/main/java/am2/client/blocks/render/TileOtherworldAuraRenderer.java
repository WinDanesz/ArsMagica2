...
public class TileOtherworldAuraRenderer extends TileEntitySpecialRenderer<TileEntityOtherworldAura> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("arsmagica2", "textures/blocks/custom/otheworld_aura.png");

    public TileOtherworldAuraRenderer() {
    }

    public void render(TileEntityOtherworldAura tile, double d1, double d2, double d3, float f, int destroyStage, float alpha) {
