...
public class TileSummonerRenderer extends TileEntitySpecialRenderer<TileEntitySummoner> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("arsmagica2", "textures/blocks/custom/summoner.png");
    private static final ResourceLocation POWERED_TEXTURE = new ResourceLocation("arsmagica2", "textures/blocks/custom/essence_conduit.png");
