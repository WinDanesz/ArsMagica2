...
public final class CompendiumCategory {
    ...
    public static final CompendiumCategory GUIDE = createCompendiumCategory("guide", new ResourceLocation(ArsMagica.MODID, "items/arcane_compendium"));
    public static final CompendiumCategory MECHANIC = createCompendiumCategory("mechanic", new ResourceLocation(ArsMagica.MODID, "items/magitech_goggle"));
    ...
    public static final CompendiumCategory MECHANIC_RITUALS = createCompendiumCategory("mechanic.rituals", new ResourceLocation("missingno"));
    public static final CompendiumCategory MECHANIC_STRUCTURES = createCompendiumCategory("mechanic.structures", new ResourceLocation("missingno"));
    public static final CompendiumCategory ITEM = createCompendiumCategory("item", new ResourceLocation(ArsMagica.MODID, "items/essence_ice"));
    ...
    public static final CompendiumCategory BLOCK = createCompendiumCategory("block", new ResourceLocation(ArsMagica.MODID, "items/crystal_wrench"));
    ...
    public static final CompendiumCategory SPELL_SHAPE = createCompendiumCategory("shape", new ResourceLocation(ArsMagica.MODID, "items/spells/shapes/binding"));
    public static final CompendiumCategory SPELL_COMPONENT = createCompendiumCategory("component", new ResourceLocation(ArsMagica.MODID, "items/spells/components/life_tap"));
    public static final CompendiumCategory SPELL_MODIFIER = createCompendiumCategory("modifier", new ResourceLocation(ArsMagica.MODID, "items/spells/modifiers/velocity_added"));
    public static final CompendiumCategory TALENT = createCompendiumCategory("talent", new ResourceLocation(ArsMagica.MODID, "items/spells/skills/augmented_casting"));
    public static final CompendiumCategory MOB = createCompendiumCategory("mob", new ResourceLocation(ArsMagica.MODID, "items/crystal_phylactery"));
    public static final CompendiumCategory MOB_FLICKER = createCompendiumCategory("mob.flicker", new ResourceLocation("missingno"));
    public static final CompendiumCategory STRUCTURE = createCompendiumCategory("structure", new ResourceLocation(ArsMagica.MODID, "gui_icons/gateway"));
    public static final CompendiumCategory BOSS = createCompendiumCategory("boss", new ResourceLocation(ArsMagica.MODID, "items/evil_book"));
