    ...
    public void updateTask() {
        ...
        if (guardian.getAttackTarget() != null) {
            ...
            if (guardian.getTicksInCurrentAction() == 7) {
                ...
                ISpellCaster spell = SpellCaster.of(NPCSpells.getInstance().enderGuardian_enderWave);
                if (spell != null) {
                    spell.cast(NPCSpells.getInstance().enderGuardian_enderWave, guardian.world, guardian);
                }
            } else {
                guardian.faceEntity(guardian.getAttackTarget(), 180, 180);
            }
