...
public class FlickerOperatorItemTransport extends AbstractFlickerFunctionality {
    ...
    public boolean DoOperation(World world, IFlickerController<?> controller, boolean powered, Affinity[] flickers) {
        ...
        //if(powered){
        for (int i = 0; i < 6; i++) {
            if (flickers[i] == Affinities.arcane) {
                toMove += 32;
            }
        }
        //}
    ...
    public int TimeBetweenOperation(boolean powered, Affinity[] flickers) {
        if (powered) {
            ...
            for (int i = 0; i < 6; i++) {
                if (flickers[i] == Affinities.lightning) {
    ...
    public Object[] getRecipe() {
        return new Object[]{
                ...
                Character.valueOf('C'), new ItemStack(AMItems.chimerite),
                Character.valueOf('B'), new ItemStack(AMItems.blue_topaz)
        };
    }
    ...
    public Affinity[] getMask() {
        return new Affinity[]{Affinities.air};
    }
