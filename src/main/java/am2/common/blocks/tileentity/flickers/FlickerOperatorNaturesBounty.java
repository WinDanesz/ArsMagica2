...
public class FlickerOperatorNaturesBounty extends AbstractFlickerFunctionality{
	...
	public Object[] getRecipe(){
		return new Object[]{
				...
				//todo registry Character.valueOf('L'), new ItemStack(ItemDefs.flickerJar, 1, ArsMagicaAPI.getAffinityRegistry().getId(Affinity.LIFE)),
				//todo registry Character.valueOf('A'), new ItemStack(ItemDefs.flickerJar, 1, ArsMagicaAPI.getAffinityRegistry().getId(Affinity.NATURE)),
