...
public class BlockCrystalMarker extends BlockAMContainer {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() == AMItems.crystal_wrench) {
            ...
            return false;
        } else if (!stack.isEmpty() && stack.getItem() == AMItems.attuning_staff) {
            ...
            player.openGui(ArsMagica.instance, IDDefs.GUI_CRYSTAL_MARKER, world, pos.getX(), pos.getY(), pos.getZ());
            return true;
        }
