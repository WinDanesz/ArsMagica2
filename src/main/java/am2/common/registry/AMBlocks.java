...
public final class AMBlocks {
    ...
    public static final Block draining_well = placeholder();
    ...
    public static void register(RegistryEvent.Register<Block> event) {
        ...
        registerBlock(registry, "draining_well", new BlockDrainingWell());
    ...
    public static void registerTileEntities() {
        ...
        GameRegistry.registerTileEntity(TileEntityDrainingWell.class, new ResourceLocation(ArsMagica.MODID, "mana_drain"));
