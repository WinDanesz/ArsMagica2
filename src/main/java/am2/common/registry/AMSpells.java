...
public class AMSpells {
 ...
 //   public static final SpellPart slice = placeholder();
  ...
  //      SpellRegistryHelper.registerSpellShape(registry, "slice", getShapeTexture("Slice"), SkillPoint.RED_SKILL_POINT, new Slice(), SkillTrees.TREE_OFFENSE, 413, 315, "arsmagica2:wave");
        ...
        // Note: Heal is not registered as a channel component, so it applies every 10 ticks
        // This keeps mana cost reasonable (~450 mana/sec instead of 4500)
...
//
//		//offense tree
//		SpellRegistry.registerSpellShape("projectile", getShapeTexture("Projectile"), SkillPoint.BLUE_SKILL_POINT, new Projectile(), SkillTrees.TREE_OFFENSE, 300, 45);
//		SpellRegistry.registerSpellComponent("physical_damage", getComponentTexture("PhysicalDamage"), SkillPoint.BLUE_SKILL_POINT, new PhysicalDamage(), SkillTrees.TREE_OFFENSE, 300, 90, "arsmagica2:projectile");
//		SpellRegistry.registerSpellModifier("gravity", getModifierTexture("Gravity"), SkillPoint.BLUE_SKILL_POINT, new Gravity(), SkillTrees.TREE_OFFENSE, 255, 70, "arsmagica2:projectile");
//		SpellRegistry.registerSpellModifier("bounce", getModifierTexture("Bounce"), SkillPoint.BLUE_SKILL_POINT, new Bounce(), SkillTrees.TREE_OFFENSE, 345, 70, "arsmagica2:projectile");
//
//		SpellRegistry.registerSpellComponent("fire_damage", getComponentTexture("FireDamage"), SkillPoint.BLUE_SKILL_POINT, new FireDamage(), SkillTrees.TREE_OFFENSE, 210, 135, "arsmagica2:physical_damage");
//		SpellRegistry.registerSpellComponent("lightning_damage", getComponentTexture("LightningDamage"), SkillPoint.BLUE_SKILL_POINT, new LightningDamage(), SkillTrees.TREE_OFFENSE, 255, 135, "arsmagica2:fire_damage");
//		SpellRegistry.registerSpellComponent("ignition", getComponentTexture("Ignition"), SkillPoint.GREEN_SKILL_POINT, new Ignition(), SkillTrees.TREE_OFFENSE, 165, 135, "arsmagica2:fire_damage");
//		SpellRegistry.registerSpellComponent("forge", getComponentTexture("Forge"), SkillPoint.GREEN_SKILL_POINT, new Forge(), SkillTrees.TREE_OFFENSE, 120, 135, "arsmagica2:ignition");
//
//		SpellRegistry.registerSpellComponent("magic_damage", getComponentTexture("MagicDamage"), SkillPoint.BLUE_SKILL_POINT, new MagicDamage(), SkillTrees.TREE_OFFENSE, 390, 135, "arsmagica2:physical_damage");
//		SpellRegistry.registerSpellComponent("frost_damage", getComponentTexture("FrostDamage"), SkillPoint.BLUE_SKILL_POINT, new FrostDamage(), SkillTrees.TREE_OFFENSE, 345, 135, "arsmagica2:magic_damage");
//
//		SpellRegistry.registerSpellComponent("drown", getComponentTexture("Drown"), SkillPoint.BLUE_SKILL_POINT, new Drown(), SkillTrees.TREE_OFFENSE, 435, 135, "arsmagica2:magic_damage");
//
//		SpellRegistry.registerSpellComponent("blind", getComponentTexture("Blind"), SkillPoint.GREEN_SKILL_POINT, new Blind(), SkillTrees.TREE_OFFENSE, 233, 180, "arsmagica2:fire_damage", "arsmagica2:lightning_damage");
//		SpellRegistry.registerSpellShape("aoe", getShapeTexture("AoE"), SkillPoint.GREEN_SKILL_POINT, new AoE(), SkillTrees.TREE_OFFENSE, 300, 180, "arsmagica2:frost_damage", "arsmagica2:physical_damage", "arsmagica2:fire_damage", "arsmagica2:lightning_damage", "arsmagica2:magic_damage");
//		SpellRegistry.registerSpellComponent("freeze", getComponentTexture("Freeze"), SkillPoint.GREEN_SKILL_POINT, new Freeze(), SkillTrees.TREE_OFFENSE, 345, 180, "arsmagica2:frost_damage");
//		SpellRegistry.registerSpellComponent("knockback", getComponentTexture("Knockback"), SkillPoint.GREEN_SKILL_POINT, new Knockback(), SkillTrees.TREE_OFFENSE, 390, 180, "arsmagica2:magic_damage");
//
//		SpellRegistry.registerSpellShape("contingency_fire", getShapeTexture("Contingency_Fire"), SkillPoint.GREEN_SKILL_POINT, new Contingency_Fire(), SkillTrees.TREE_OFFENSE, 165, 190, "arsmagica2:ignition");
//		SpellRegistry.registerSpellModifier("solar", getModifierTexture("Solar"), SkillPoint.RED_SKILL_POINT, new Solar(), SkillTrees.TREE_OFFENSE, 210, 255, "arsmagica2:blind");
//
//		SpellRegistry.registerSpellComponent("storm", getComponentTexture("Storm"), SkillPoint.RED_SKILL_POINT, new Storm(), SkillTrees.TREE_OFFENSE, 255, 225, "arsmagica2:lightning_damage");
//		SpellRegistry.registerSpellComponent("astral_distortion", getComponentTexture("AstralDistortion"), SkillPoint.GREEN_SKILL_POINT, new AstralDistortion(), SkillTrees.TREE_OFFENSE, 367, 215, "arsmagica2:magic_damage", "arsmagica2:frost_damage");
//		SpellRegistry.registerSpellComponent("silence", getComponentTexture("Silence"), SkillPoint.RED_SKILL_POINT, new Silence(), SkillTrees.TREE_OFFENSE, 345, 245, "arsmagica2:astral_distortion");
//
//		SpellRegistry.registerSpellComponent("fling", getComponentTexture("Fling"), SkillPoint.GREEN_SKILL_POINT, new Fling(), SkillTrees.TREE_OFFENSE, 390, 245, "arsmagica2:knockback");
//		SpellRegistry.registerSpellModifier("velocity_added", getModifierTexture("VelocityAdded"), SkillPoint.RED_SKILL_POINT, new VelocityAdded(), SkillTrees.TREE_OFFENSE, 390, 290, "arsmagica2:fling");
//		SpellRegistry.registerSpellComponent("watery_grave", getComponentTexture("WateryGrave"), SkillPoint.GREEN_SKILL_POINT, new WateryGrave(), SkillTrees.TREE_OFFENSE, 435, 245, "arsmagica2:drown");
//
//		SpellRegistry.registerSpellModifier("piercing", getModifierTexture("Piercing"), SkillPoint.RED_SKILL_POINT, new Piercing(), SkillTrees.TREE_OFFENSE, 323, 215, "arsmagica2:freeze");
//
//		SpellRegistry.registerSpellShape("beam", getShapeTexture("Beam"), SkillPoint.RED_SKILL_POINT, new Beam(), SkillTrees.TREE_OFFENSE, 300, 270, "arsmagica2:aoe");
//		SpellRegistry.registerSpellModifier("damage", getModifierTexture("Damage"), SkillPoint.RED_SKILL_POINT, new Damage(), SkillTrees.TREE_OFFENSE, 300, 315, "arsmagica2:beam");
//		SpellRegistry.registerSpellComponent("fury", getComponentTexture("Fury"), SkillPoint.RED_SKILL_POINT, new Fury(), SkillTrees.TREE_OFFENSE, 255, 315, "arsmagica2:beam", "arsmagica2:storm");
//		SpellRegistry.registerSpellShape("wave", getShapeTexture("Wave"), SkillPoint.RED_SKILL_POINT, new Wave(), SkillTrees.TREE_OFFENSE, 367, 315, "arsmagica2:beam", "arsmagica2:fling");
//
//		SpellRegistry.registerSpellComponent("blizzard", getComponentTexture("Blizzard"), SkillPoint.SILVER_POINT, new Blizzard(), SkillTrees.TREE_OFFENSE, 75, 45);
//		SpellRegistry.registerSpellComponent("falling_star", getComponentTexture("FallingStar"), SkillPoint.SILVER_POINT, new FallingStar(), SkillTrees.TREE_OFFENSE, 75, 90);
//		SpellRegistry.registerSpellComponent("fire_rain", getComponentTexture("FireRain"), SkillPoint.SILVER_POINT, new FireRain(), SkillTrees.TREE_OFFENSE, 75, 135);
//		SpellRegistry.registerSpellComponent("mana_blast", getComponentTexture("ManaBlast"), SkillPoint.SILVER_POINT, new ManaBlast(), SkillTrees.TREE_OFFENSE, 75, 180);
//		SpellRegistry.registerSpellModifier("dismembering", getModifierTexture("Dismembering"), SkillPoint.SILVER_POINT, new Dismembering(), SkillTrees.TREE_OFFENSE, 75, 225);
//
//		//defense tree
//		SpellRegistry.registerSpellShape("self", getShapeTexture("Self"), SkillPoint.BLUE_SKILL_POINT, new Self(), SkillTrees.TREE_DEFENSE, 267, 45);
//
//		SpellRegistry.registerSpellComponent("leap", getComponentTexture("Leap"), SkillPoint.BLUE_SKILL_POINT, new Leap(), SkillTrees.TREE_DEFENSE, 222, 90, "arsmagica2:self");
//		SpellRegistry.registerSpellComponent("regeneration", getComponentTexture("Regeneration"), SkillPoint.BLUE_SKILL_POINT, new Regeneration(), SkillTrees.TREE_DEFENSE, 357, 90, "arsmagica2:self");
//
//		SpellRegistry.registerSpellComponent("shrink", getComponentTexture("Shrink"), SkillPoint.BLUE_SKILL_POINT, new Shrink(), SkillTrees.TREE_DEFENSE, 402, 90, "arsmagica2:regeneration");
//		SpellRegistry.registerSpellComponent("slowfall", getComponentTexture("Slowfall"), SkillPoint.BLUE_SKILL_POINT, new Slowfall(), SkillTrees.TREE_DEFENSE, 222, 135, "arsmagica2:leap");
//		SpellRegistry.registerSpellComponent("heal", getComponentTexture("Heal"), SkillPoint.BLUE_SKILL_POINT, new Heal(), SkillTrees.TREE_DEFENSE, 357, 135, "arsmagica2:regeneration");
//		SpellRegistry.registerSpellComponent("life_tap", getComponentTexture("LifeTap"), SkillPoint.GREEN_SKILL_POINT, new LifeTap(), SkillTrees.TREE_DEFENSE, 312, 135, "arsmagica2:heal");
//		SpellRegistry.registerSpellModifier("healing", getModifierTexture("Healing"), SkillPoint.RED_SKILL_POINT, new Healing(), SkillTrees.TREE_DEFENSE, 402, 135, "arsmagica2:heal");
//
//		SpellRegistry.registerSpellComponent("summon", getComponentTexture("Summon"), SkillPoint.GREEN_SKILL_POINT, new Summon(), SkillTrees.TREE_DEFENSE, 267, 135, "arsmagica2:life_tap");
//		SpellRegistry.registerSpellShape("contingency_damage", getShapeTexture("Contingency_Damage"), SkillPoint.GREEN_SKILL_POINT, new Contingency_Hit(), SkillTrees.TREE_DEFENSE, 447, 180, "arsmagica2:healing");
//
//		SpellRegistry.registerSpellComponent("haste", getComponentTexture("Haste"), SkillPoint.BLUE_SKILL_POINT, new Haste(), SkillTrees.TREE_DEFENSE, 177, 155, "arsmagica2:slowfall");
//		SpellRegistry.registerSpellComponent("slow", getComponentTexture("Slow"), SkillPoint.BLUE_SKILL_POINT, new Slow(), SkillTrees.TREE_DEFENSE, 132, 155, "arsmagica2:slowfall");
//
//		SpellRegistry.registerSpellComponent("gravity_well", getComponentTexture("GravityWell"), SkillPoint.GREEN_SKILL_POINT, new GravityWell(), SkillTrees.TREE_DEFENSE, 222, 180, "arsmagica2:slowfall");
//		SpellRegistry.registerSpellComponent("life_drain", getComponentTexture("LifeDrain"), SkillPoint.GREEN_SKILL_POINT, new LifeDrain(), SkillTrees.TREE_DEFENSE, 312, 180, "arsmagica2:life_tap");
//		SpellRegistry.registerSpellComponent("dispel", getComponentTexture("Dispel"), SkillPoint.GREEN_SKILL_POINT, new Dispel(), SkillTrees.TREE_DEFENSE, 357, 180, "arsmagica2:heal");
//
//		SpellRegistry.registerSpellShape("contingency_fall", getShapeTexture("Contingency_Fall"), SkillPoint.GREEN_SKILL_POINT, new Contingency_Fall(), SkillTrees.TREE_DEFENSE, 267, 180, "arsmagica2:gravity_well");
//
//		SpellRegistry.registerSpellComponent("swift_swim", getComponentTexture("SwiftSwim"), SkillPoint.BLUE_SKILL_POINT, new SwiftSwim(), SkillTrees.TREE_DEFENSE, 177, 200, "arsmagica2:haste");
//		SpellRegistry.registerSpellComponent("repel", getComponentTexture("Repel"), SkillPoint.GREEN_SKILL_POINT, new Repel(), SkillTrees.TREE_DEFENSE, 132, 200, "arsmagica2:slow");
//
//		SpellRegistry.registerSpellComponent("levitate", getComponentTexture("Levitate"), SkillPoint.GREEN_SKILL_POINT, new Levitation(), SkillTrees.TREE_DEFENSE, 222, 225, "arsmagica2:gravity_well");
//		SpellRegistry.registerSpellComponent("mana_drain", getComponentTexture("ManaDrain"), SkillPoint.GREEN_SKILL_POINT, new ManaDrain(), SkillTrees.TREE_DEFENSE, 312, 225, "arsmagica2:life_drain");
//		SpellRegistry.registerSpellShape("zone", getShapeTexture("Zone"), SkillPoint.RED_SKILL_POINT, new Zone(), SkillTrees.TREE_DEFENSE, 357, 225, "arsmagica2:dispel");
//
//		SpellRegistry.registerSpellShape("wall", getShapeTexture("Wall"), SkillPoint.GREEN_SKILL_POINT, new Wall(), SkillTrees.TREE_DEFENSE, 87, 200, "arsmagica2:repel");
//		SpellRegistry.registerSpellComponent("accelerate", getComponentTexture("Accelerate"), SkillPoint.GREEN_SKILL_POINT, new Accelerate(), SkillTrees.TREE_DEFENSE, 177, 245, "arsmagica2:swift_swim");
//		SpellRegistry.registerSpellComponent("entangle", getComponentTexture("Entangle"), SkillPoint.GREEN_SKILL_POINT, new Entangle(), SkillTrees.TREE_DEFENSE, 132, 245, "arsmagica2:repel");
//		SpellRegistry.registerSpellComponent("appropriation", getComponentTexture("Appropriation"), SkillPoint.RED_SKILL_POINT, new Appropriation(), SkillTrees.TREE_DEFENSE, 87, 245, "arsmagica2:entangle");
//
//		SpellRegistry.registerSpellComponent("flight", getComponentTexture("Flight"), SkillPoint.RED_SKILL_POINT, new Flight(), SkillTrees.TREE_DEFENSE, 222, 270, "arsmagica2:levitate");
//		SpellRegistry.registerSpellComponent("shield", getComponentTexture("Shield"), SkillPoint.BLUE_SKILL_POINT, new Shield(), SkillTrees.TREE_DEFENSE, 357, 270, "arsmagica2:zone");
//
//		SpellRegistry.registerSpellShape("contingency_health", getShapeTexture("Contingency_Health"), SkillPoint.RED_SKILL_POINT, new Contingency_Health(), SkillTrees.TREE_DEFENSE, 402, 270, "arsmagica2:shield");
//
//		SpellRegistry.registerSpellShape("rune", getShapeTexture("Rune"), SkillPoint.GREEN_SKILL_POINT, new Rune(), SkillTrees.TREE_DEFENSE, 157, 315, "arsmagica2:accelerate", "arsmagica2:entangle");
//
//		SpellRegistry.registerSpellModifier("rune_procs", getModifierTexture("RuneProcs"), SkillPoint.GREEN_SKILL_POINT, new RuneProcs(), SkillTrees.TREE_DEFENSE, 157, 360, "arsmagica2:rune");
//
//		SpellRegistry.registerSpellModifier("speed", getModifierTexture("Speed"), SkillPoint.RED_SKILL_POINT, new Speed(), SkillTrees.TREE_DEFENSE, 202, 315, "arsmagica2:accelerate", "arsmagica2:flight");
//
//		SpellRegistry.registerSpellComponent("reflect", getComponentTexture("Reflect"), SkillPoint.RED_SKILL_POINT, new Reflect(), SkillTrees.TREE_DEFENSE, 357, 315, "arsmagica2:shield");
//		SpellRegistry.registerSpellComponent("chrono_anchor", getComponentTexture("ChronoAnchor"), SkillPoint.RED_SKILL_POINT, new ChronoAnchor(), SkillTrees.TREE_DEFENSE, 312, 315, "arsmagica2:reflect");
//
//		SpellRegistry.registerSpellModifier("duration", getModifierTexture("Duration"), SkillPoint.RED_SKILL_POINT, new Duration(), SkillTrees.TREE_DEFENSE, 312, 360, "arsmagica2:chrono_anchor");
//
//		SpellRegistry.registerSpellComponent("absorption", getComponentTexture("Absorption"), SkillPoint.RED_SKILL_POINT, new Absorption(), SkillTrees.TREE_DEFENSE, 312, 270, "arsmagica2:shield");
//
//		SpellRegistry.registerSpellComponent("mana_link", getComponentTexture("ManaLink"), SkillPoint.SILVER_POINT, new ManaLink(), SkillTrees.TREE_DEFENSE, 30, 45);
//		SpellRegistry.registerSpellComponent("mana_shield", getComponentTexture("ManaShield"), SkillPoint.SILVER_POINT, new ManaShield(), SkillTrees.TREE_DEFENSE, 30, 90);
//		SpellRegistry.registerSpellModifier("buff_power", getModifierTexture("BuffPower"), SkillPoint.SILVER_POINT, new BuffPower(), SkillTrees.TREE_DEFENSE, 30, 135);
//
//		//utility tree
//		SpellRegistry.registerSpellShape("touch", getShapeTexture("Touch"), SkillPoint.BLUE_SKILL_POINT, new Touch(), SkillTrees.TREE_UTILITY, 275, 75);
//
//		SpellRegistry.registerSpellComponent("dig", getComponentTexture("Dig"), SkillPoint.BLUE_SKILL_POINT, new Dig(), SkillTrees.TREE_UTILITY, 275, 120, "arsmagica2:touch");
//		SpellRegistry.registerSpellComponent("wizards_autumn", getComponentTexture("WizardsAutumn"), SkillPoint.BLUE_SKILL_POINT, new WizardsAutumn(), SkillTrees.TREE_UTILITY, 315, 120, "arsmagica2:dig");
//		SpellRegistry.registerSpellModifier("target_non_solid", getModifierTexture("TargetNonSolid"), SkillPoint.BLUE_SKILL_POINT, new TargetNonSolidBlocks(), SkillTrees.TREE_UTILITY, 230, 75, "arsmagica2:touch");
//
//		SpellRegistry.registerSpellComponent("place_block", getComponentTexture("PlaceBlock"), SkillPoint.BLUE_SKILL_POINT, new PlaceBlock(), SkillTrees.TREE_UTILITY, 185, 93, "arsmagica2:dig");
//		SpellRegistry.registerSpellModifier("feather_touch", getModifierTexture("FeatherTouch"), SkillPoint.BLUE_SKILL_POINT, new FeatherTouch(), SkillTrees.TREE_UTILITY, 230, 137, "arsmagica2:dig");
//		SpellRegistry.registerSpellModifier("mining_power", getModifierTexture("MiningPower"), SkillPoint.GREEN_SKILL_POINT, new MiningPower(), SkillTrees.TREE_UTILITY, 185, 137, "arsmagica2:feather_touch");
//
//		SpellRegistry.registerSpellComponent("light", getComponentTexture("Light"), SkillPoint.BLUE_SKILL_POINT, new Light(), SkillTrees.TREE_UTILITY, 275, 165, "arsmagica2:dig");
//		SpellRegistry.registerSpellComponent("night_vision", getComponentTexture("NightVision"), SkillPoint.BLUE_SKILL_POINT, new NightVision(), SkillTrees.TREE_UTILITY, 185, 165, "arsmagica2:light");
//
//		SpellRegistry.registerSpellShape("binding", getShapeTexture("Binding"), SkillPoint.BLUE_SKILL_POINT, new Binding(), SkillTrees.TREE_UTILITY, 275, 210, "arsmagica2:light");
//		SpellRegistry.registerSpellComponent("disarm", getComponentTexture("Disarm"), SkillPoint.BLUE_SKILL_POINT, new Disarm(), SkillTrees.TREE_UTILITY, 230, 210, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("charm", getComponentTexture("Charm"), SkillPoint.BLUE_SKILL_POINT, new Charm(), SkillTrees.TREE_UTILITY, 315, 235, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("true_sight", getComponentTexture("TrueSight"), SkillPoint.BLUE_SKILL_POINT, new TrueSight(), SkillTrees.TREE_UTILITY, 185, 210, "arsmagica2:night_vision");
//
//		SpellRegistry.registerSpellModifier("lunar", getModifierTexture("Lunar"), SkillPoint.RED_SKILL_POINT, new Lunar(), SkillTrees.TREE_UTILITY, 145, 210, "arsmagica2:true_sight");
//
//		SpellRegistry.registerSpellComponent("harvest_plants", getComponentTexture("HarvestPlants"), SkillPoint.GREEN_SKILL_POINT, new HarvestPlants(), SkillTrees.TREE_UTILITY, 365, 120, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("plow", getComponentTexture("Plow"), SkillPoint.BLUE_SKILL_POINT, new Plow(), SkillTrees.TREE_UTILITY, 365, 165, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("plant", getComponentTexture("Plant"), SkillPoint.BLUE_SKILL_POINT, new Plant(), SkillTrees.TREE_UTILITY, 365, 210, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("create_water", getComponentTexture("CreateWater"), SkillPoint.GREEN_SKILL_POINT, new CreateWater(), SkillTrees.TREE_UTILITY, 365, 255, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("drought", getComponentTexture("Drought"), SkillPoint.GREEN_SKILL_POINT, new Drought(), SkillTrees.TREE_UTILITY, 365, 300, "arsmagica2:binding");
//
//		SpellRegistry.registerSpellComponent("banish_rain", getComponentTexture("BanishRain"), SkillPoint.GREEN_SKILL_POINT, new BanishRain(), SkillTrees.TREE_UTILITY, 365, 345, "arsmagica2:drought");
//		SpellRegistry.registerSpellComponent("water_breathing", getComponentTexture("WaterBreathing"), SkillPoint.BLUE_SKILL_POINT, new WaterBreathing(), SkillTrees.TREE_UTILITY, 410, 345, "arsmagica2:drought");
//
//		SpellRegistry.registerSpellComponent("grow", getComponentTexture("Grow"), SkillPoint.RED_SKILL_POINT, new Grow(), SkillTrees.TREE_UTILITY, 410, 210, "arsmagica2:drought", "arsmagica2:create_water", "arsmagica2:plant", "arsmagica2:plow", "arsmagica2:harvest_plants");
//
//		SpellRegistry.registerSpellShape("chain", getShapeTexture("Chain"), SkillPoint.RED_SKILL_POINT, new Chain(), SkillTrees.TREE_UTILITY, 455, 210, "arsmagica2:grow");
//
//		SpellRegistry.registerSpellComponent("rift", getComponentTexture("Rift"), SkillPoint.GREEN_SKILL_POINT, new Rift(), SkillTrees.TREE_UTILITY, 275, 255, "arsmagica2:binding");
//		SpellRegistry.registerSpellComponent("invisibility", getComponentTexture("Invisibility"), SkillPoint.GREEN_SKILL_POINT, new Invisiblity(), SkillTrees.TREE_UTILITY, 185, 255, "arsmagica2:true_sight");
//
//		SpellRegistry.registerSpellComponent("random_teleport", getComponentTexture("RandomTeleport"), SkillPoint.BLUE_SKILL_POINT, new RandomTeleport(), SkillTrees.TREE_UTILITY, 185, 300, "arsmagica2:invisibility");
//		SpellRegistry.registerSpellComponent("attract", getComponentTexture("Attract"), SkillPoint.GREEN_SKILL_POINT, new Attract(), SkillTrees.TREE_UTILITY, 245, 300, "arsmagica2:rift");
//		SpellRegistry.registerSpellComponent("telekinesis", getComponentTexture("Telekinesis"), SkillPoint.GREEN_SKILL_POINT, new Telekinesis(), SkillTrees.TREE_UTILITY, 305, 300, "arsmagica2:rift");
//
//		SpellRegistry.registerSpellComponent("blink", getComponentTexture("Blink"), SkillPoint.GREEN_SKILL_POINT, new Blink(), SkillTrees.TREE_UTILITY, 185, 345, "arsmagica2:random_teleport");
//		SpellRegistry.registerSpellModifier("range", getModifierTexture("Range"), SkillPoint.RED_SKILL_POINT, new Range(), SkillTrees.TREE_UTILITY, 140, 345, "arsmagica2:blink");
//		SpellRegistry.registerSpellShape("channel", getShapeTexture("Channel"), SkillPoint.GREEN_SKILL_POINT, new Channel(), SkillTrees.TREE_UTILITY, 275, 345, "arsmagica2:attract", "arsmagica2:telekinesis");
//		SpellRegistry.registerSpellShape("toggle", getShapeTexture("Toggle"), SkillPoint.RED_SKILL_POINT, new Toggle(), SkillTrees.TREE_UTILITY, 315, 345, "arsmagica2:channel");
//
//		SpellRegistry.registerSpellModifier("radius", getModifierTexture("Radius"), SkillPoint.RED_SKILL_POINT, new Radius(), SkillTrees.TREE_UTILITY, 275, 390, "arsmagica2:channel");
//		SpellRegistry.registerSpellComponent("transplace", getComponentTexture("Transplace"), SkillPoint.BLUE_SKILL_POINT, new Transplace(), SkillTrees.TREE_UTILITY, 185, 390, "arsmagica2:blink");
//
//		SpellRegistry.registerSpellComponent("mark", getComponentTexture("Mark"), SkillPoint.GREEN_SKILL_POINT, new Mark(), SkillTrees.TREE_UTILITY, 155, 435, "arsmagica2:transplace");
//		SpellRegistry.registerSpellComponent("recall", getComponentTexture("Recall"), SkillPoint.GREEN_SKILL_POINT, new Recall(), SkillTrees.TREE_UTILITY, 215, 435, "arsmagica2:transplace");
//
//		SpellRegistry.registerSpellComponent("divine_intervention", getComponentTexture("DivineIntervention"), SkillPoint.RED_SKILL_POINT, new DivineIntervention(), SkillTrees.TREE_UTILITY, 172, 480, "arsmagica2:recall", "arsmagica2:mark");
//		SpellRegistry.registerSpellComponent("ender_intervention", getComponentTexture("EnderIntervention"), SkillPoint.RED_SKILL_POINT, new EnderIntervention(), SkillTrees.TREE_UTILITY, 198, 480, "arsmagica2:recall", "arsmagica2:mark");
//
//		SpellRegistry.registerSpellShape("contingency_death", getShapeTexture("Contingency_Death"), SkillPoint.RED_SKILL_POINT, new Contingency_Death(), SkillTrees.TREE_UTILITY, 198, 524, "arsmagica2:ender_intervention");
//
//		SpellRegistry.registerSpellComponent("daylight", getComponentTexture("Daylight"), SkillPoint.SILVER_POINT, new Daylight(), SkillTrees.TREE_UTILITY, 75, 45);
//		SpellRegistry.registerSpellComponent("moonrise", getComponentTexture("Moonrise"), SkillPoint.SILVER_POINT, new Moonrise(), SkillTrees.TREE_UTILITY, 75, 90);
//		SpellRegistry.registerSpellModifier("prosperity", getModifierTexture("Prosperity"), SkillPoint.SILVER_POINT, new Prosperity(), SkillTrees.TREE_UTILITY, 75, 135);
    }
