...
public class ItemArcaneGuardianSpellbook extends ItemSpellBook {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(I18n.translateToLocalFormatted("am2.tooltip.arcanespellbook"));
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack) {
        ...
        if (!activeSpell.isEmpty())
            return String.format("\2477%s \2477(" + activeSpell.getDisplayName() + "\2477)", I18n.translateToLocalFormatted("item.arsmagica2:arcane_spellbook.name"));
        return I18n.translateToLocalFormatted("item.arsmagica2:arcane_spellbook.name");
    }
}
