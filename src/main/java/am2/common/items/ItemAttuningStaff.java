...
public class ItemAttuningStaff extends Item {
    ...
    public ItemAttuningStaff(int charge, int castingMode) {
        super();
        this.setMaxDamage(0);
     ...
     * @return
     */
    public ItemAttuningStaff setStaffHeadIndex(int index) {
        if (index > 3 || index < 0) {
            index = 0;
        }
        return this;
    ...
    public void onUpdate(ItemStack stack, World world, Entity entity, int par4, boolean par5) {
        ...
        if (entity instanceof EntityPlayerSP) {
            ...
            if (!usingItem.isEmpty() && usingItem.getItem() == this) {
                if (SkillData.For(player).hasSkill(AMSkills.spell_motion.getID())) {
