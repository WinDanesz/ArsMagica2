...
public class ContainerCalefactor extends AM2Container {
    ...
    public void addListener(IContainerListener listener) {
        ...
        listener.sendAllWindowProperties(this, this.calefactor);
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (IContainerListener listener : this.listeners) {
            if (this.cookTime != this.calefactor.getField(0)) {
                listener.sendWindowProperty(this, 0, this.calefactor.getField(0));
            }
        }

        this.cookTime = this.calefactor.getField(0);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public void updateProgressBar(int id, int data) {
        this.calefactor.setField(id, data);
    }
