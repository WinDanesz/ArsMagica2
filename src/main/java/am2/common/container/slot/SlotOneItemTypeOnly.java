...
public class SlotOneItemTypeOnly extends Slot {
    ...
    public boolean isItemValid(ItemStack par1ItemStack) {
        if (meta == -1)
            return !par1ItemStack.isEmpty() && par1ItemStack.getItem() == this.item;
        return !par1ItemStack.isEmpty() && par1ItemStack.getItem() == this.item && par1ItemStack.getItemDamage() == meta;
    }
