...
public class ContainerArcaneDeconstructor extends AM2Container {
    ...
    private int deconstructionTime;
    ...
    public ContainerArcaneDeconstructor(InventoryPlayer inventoryplayer, TileEntityArcaneDeconstructor deconstructor) {
        ...
        //foci
        this.addSlotToContainer(new SlotOneItemTypeOnly(deconstructor, 10, 62, 28, AMItems.charge_focus));
        this.addSlotToContainer(new SlotOneItemTypeOnly(deconstructor, 11, 80, 28, AMItems.charge_focus));
        this.addSlotToContainer(new SlotOneItemTypeOnly(deconstructor, 12, 98, 28, AMItems.charge_focus));
    ...
    public void addListener(IContainerListener listener) {
        ...
        listener.sendAllWindowProperties(this, this.deconstructor);
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (IContainerListener listener : this.listeners) {
            if (this.deconstructionTime != this.deconstructor.getField(0)) {
                listener.sendWindowProperty(this, 0, this.deconstructor.getField(0));
            }
        }

        this.deconstructionTime = this.deconstructor.getField(0);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public void updateProgressBar(int id, int data) {
        this.deconstructor.setField(id, data);
    }
